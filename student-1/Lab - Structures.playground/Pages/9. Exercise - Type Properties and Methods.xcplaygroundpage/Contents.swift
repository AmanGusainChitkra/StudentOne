 ...
 */
struct User {
    static var currentUser: User = User(userName: "kartikvats", email: "kartikvats@icloud.com", age: 21)
...
let newUser = User(userName: "ghostRider", email: "ghostRider@icloud.com", age: 21)
