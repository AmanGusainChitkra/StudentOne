...
var isabelle = User(name: "Aman", age: 21, height: 68, weight: 145, activityLevel: 8)
print("My name is \(isabelle.name) and I am \(isabelle.age), weight is \(isabelle.weight) lbs and am \(isabelle.height) inches tall. On an activity scale from 1-10 I am probably a \(isabelle.activityLevel).")
/*:
...
let newDistance = Distance(meters: 3102)
